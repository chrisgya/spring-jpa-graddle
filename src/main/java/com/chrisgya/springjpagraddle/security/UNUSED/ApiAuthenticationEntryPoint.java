...
import static com.chrisgya.springjpagraddle.security.Constants.TOKEN_URL;
...
public class ApiAuthenticationEntryPoint implements AuthenticationEntryPoint {
  ...
  public void commence(HttpServletRequest req, HttpServletResponse res, AuthenticationException e)
    ...
    var error = ErrorUtils.createError(errorMsg, ErrorCode.UNAUTHORIZED.getErrCode(),
            HttpStatus.UNAUTHORIZED.value()).setUrl(TOKEN_URL).setReqMethod(req.getMethod()).setTimestamp(Instant.now());
