...
import com.chrisgya.springjpagraddle.entity.RoleEnum;
import com.chrisgya.springjpagraddle.security.UNUSED.ApiAccessDeniedHandler;
import com.chrisgya.springjpagraddle.security.UNUSED.ApiAuthenticationEntryPoint;
import com.chrisgya.springjpagraddle.security.UNUSED.FilterChainFailureHandler;
...
import static com.chrisgya.springjpagraddle.security.Constants.*;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.httpBasic().disable().formLogin().disable()
                ...
                .antMatchers(SWAGGER_UI_HTML, SWAGGER_UI, API_DOCS).permitAll()
