...
import com.chrisgya.springjpagraddle.exception.ResourceNotFoundException;
...
public class AddressServiceTest {
  ...
  public void deleteAddressesByIdWhenExists() {
    //given(repository.findById(UUID.fromString(nonExistId))).willReturn(Optional.of(entity));
